...
print('(CRITICAL) YOU ARE USING AN OUTDATED VERSION OF ATLAS: In order to fix this, please change any occurence of "rd2glory.com" with "siegehub.net" in your script, as we are currently going through a domain change. This outdated version will eventually be taken down and you will be forced to make this change.')
